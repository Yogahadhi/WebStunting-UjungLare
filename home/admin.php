...
$sql = $koneksi->query("SELECT COUNT(id_stunting) as stunting  from tb_stunting");
while ($data = $sql->fetch_assoc()) {
	$stunting = $data['stunting'];
}

$sql = $koneksi->query("SELECT COUNT(id_stunting) as penyintas  from tb_stunting where kategori = 'Stunting'");
while ($data = $sql->fetch_assoc()) {
	$penyintas = $data['penyintas'];
}

$sql = $koneksi->query("SELECT COUNT(id_stunting) as berisiko  from tb_stunting where kategori = 'Berisiko'");
while ($data = $sql->fetch_assoc()) {
	$berisiko = $data['berisiko'];
}
...
<div class="row">
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-info">
			...
			<a href="index.php?page=data-stunting" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-success">
			...
			<a href="index.php?page=data-penyintas" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-red">
			...
			<a href="index.php?page=data-berisiko" class="small-box-footer">Selengkapnya
				<i class="fas fa-arrow-circle-right"></i>
			</a>
		</div>
	</div>
